...
summary: 'Build a DIY smart thermostat for Mitsubishi heat pumps using ESP32, ESPHome, and Home Assistant for under $15.'
tags: ['homelab', 'iot', 'esphome', 'home-assistant']
---
